...
public class ConsoleUtils {
	...
	/*
	 * 219 DB U+2588 â–ˆ full block 220 DC U+2584 â–„ lower half block 221 DD U+258C
	 * â–Œ left half block 222 DE U+2590 â–� right half block 223 DF U+2580 â–€ upper
	 * half block
	 */
	...
	public String getDateTime(String pattern){
		...
		String dateTime = dt.format(DateTimeFormatter.ofPattern(pattern));
		return dateTime;
	}
	
	public int getMinuteValue(int currentValue){
			...
			if(currentValue % 5 == 0){
				...
				div = currentValue / 5;	
				reminder = currentValue % 5;
				if(reminder>5){
					currentValue = currentValue + (10-reminder);
				}else{
					currentValue = currentValue + (5-reminder);
				}
			}
